...
public class Pc extends Componente {
	...
	protected Pc(String id, String descripcion, String marca, String modelo, 
			List<ComponenteSimple> subComponentes, String tipo) {
		super(id, descripcion, marca, modelo, new BigDecimal(0), new BigDecimal(0), tipo);
	...
	protected Pc(PcBuilder config) {
		super(config.getIdPc(), config.getDescripcionPc(), 
			  config.getMarcaPc(), config.getModeloPc(), new BigDecimal(0), new BigDecimal(0), config.getTipo());
